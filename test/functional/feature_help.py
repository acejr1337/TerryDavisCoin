...
"""Verify that starting terrydaviscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start terrydaviscoin with -h for help text")
        ...
        self.log.info("Start terrydaviscoin with -version for version information")
        ...
        self.log.info("Start terrydaviscoind with -fakearg to make sure it does not start")
