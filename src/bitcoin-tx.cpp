...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " terrydaviscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  terrydaviscoin-tx [options] <hex-tx> [commands]  Update hex-encoded terrydaviscoin transaction\n" +
            "or:     terrydaviscoin-tx [options] -create [commands]   Create hex-encoded terrydaviscoin transaction\n" +
            "\n";
