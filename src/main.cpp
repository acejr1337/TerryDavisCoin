...
#if defined(NDEBUG)
# error "TerryDavisCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x9208e13a0b20271aa1c1ff42ab4581683591d1ea4f89e66ba3710a8191a412b4");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TerryDavisCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TerryDavisCoin Signed Message:\n";
...
{
    // TerryDavisCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 210000); // TerryDavisCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 14 * 24 * 60 * 60; // TerryDavisCoin: 3.5 days
static const int64 nTargetSpacing = 10 * 60; // TerryDavisCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TerryDavisCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TerryDavisCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        pchMessageStart[0] = 0xfu;
        pchMessageStart[1] = 0xc8;
        pchMessageStart[2] = 0xb1;
        pchMessageStart[3] = 0xdf;
        hashGenesisBlock = uint256("0x13e3c907dc39f50278d843d5120db2bde2564bfbec3ba46ac281f5928cbe7dfc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e42b9ec027013103d938ea49fb3ed35831f31ea18ae8a69aaee2017a7862af1af47c67b31138847f19b9d0dbbe35f7ab6c46c2c8a92c03d875ca33ac60e539d3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1632446536;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085387681;

        if (fTestNet)
        {
            block.nTime    = 1632446516;
            block.nNonce   = 385543215;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x11a2b0d72e968801026a129049240d0136ce4052828ef8245d8c3b14aad5e3bd"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfl, 0xc7, 0xb0, 0xdf }; // TerryDavisCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TerryDavisCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TerryDavisCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static TerryDavisCoinMiner(CWallet *pwallet)
{
    printf("TerryDavisCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("terrydaviscoin-miner");
    ...
    try { loop {
        ...
        printf("Running TerryDavisCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("TerryDavisCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&TerryDavisCoinMiner, pwallet));
}
