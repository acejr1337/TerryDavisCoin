...
bech32_templates = [
  ...
  ('tdc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('tdc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('tdc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('ttdc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('ttdc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('ttdc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rtdc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rtdc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rtdc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('ttdc',  17, 32, False, False, False),
  ('rtdc',  3,  1, False, False, False),
  ('tdc',   15, 41, False, False, False),
  ('ttdc',  0, 16, False, False, False),
  ('rtdc',  0, 32, True,  False, False),
  ('tdc',   0, 16, True,  False, False),
  ('ttdc',  0, 32, False, True,  False),
  ('rtdc',  0, 20, False, False, True)
]
